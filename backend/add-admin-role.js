...
try {
  ...
  db.exec(`
    INSERT INTO users_temp (id, email, password, fullName, phone, role, avatar, pushToken, latitude, longitude, address, isPhoneVerified, isBanned, isApproved, createdAt)
